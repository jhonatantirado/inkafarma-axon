package pe.edu.unmsm.upg.inkafarma.customers.api;

import pe.edu.unmsm.upg.inkafarma.customers.application.RegisterCustomerRequestDto;
import pe.edu.unmsm.upg.inkafarma.customers.application.EditCustomerRequestDto;
import pe.edu.unmsm.upg.inkafarma.customers.application.RegisterCustomerErrorResponseDto;
import pe.edu.unmsm.upg.inkafarma.customers.application.EditCustomerErrorResponseDto;
import pe.edu.unmsm.upg.inkafarma.customers.application.EditCustomerOkResponseDto;
import pe.edu.unmsm.upg.inkafarma.customers.application.RegisterCustomerOkResponseDto;
...
import pe.edu.unmsm.upg.inkafarma.customers.messages.commands.*;
